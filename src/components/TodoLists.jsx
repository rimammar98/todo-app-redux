...
import { deleteTodo, editTodo, markTodoCompleted, clearAlltodo, markPending } from "../redux/action";
...
export const TodoLists = () => {
  ...
  const markAsPending = () => {
    dispatch(markPending(selectedTodo));
  };
        ...
        <div className="col-xl-12 text-right">
          {selectedTodo.length > 0 && (
            <>
              ...
              <button className="btn btn-warning ml-2" onClick={markAsPending}>
  Mark As Pending
</button>
